...
nlp = spacy.load('en_core_web_sm') #use for tokeinzation and remove stopwords from dataset
...
def home():
    ...
    return render_template('NewsClassify.html', Category = Cat)  # render a template
...
def Classfy():
    ...
    if request.method == 'POST':
        model = joblib.load(r'news_classifier.pkl')
